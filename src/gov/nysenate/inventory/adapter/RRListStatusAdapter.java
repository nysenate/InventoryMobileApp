...
public class RRListStatusAdapter extends ArrayAdapter<RemovalRequest>
{
    ...
    public RRListStatusAdapter(Context context, int resource, int textViewResource, List<RemovalRequest> rrs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView column6 = (TextView) row.findViewById(R.id.column6);
