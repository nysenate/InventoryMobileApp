...
public class MsgAlert
{
    ...
    public MsgAlert (Context context, final String title, final String message, OnClickListener onClickListener) {
        this.context = context;
    ...
    public void showMessage(String title, String message, OnClickListener onClickListener) {
