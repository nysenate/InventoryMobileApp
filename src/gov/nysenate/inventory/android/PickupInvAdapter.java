...
public class PickupInvAdapter extends ArrayAdapter<InvItem> {
    ...
    public PickupInvAdapter(Context context, int resourceId,
            List<InvItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowItem.getType().toUpperCase().startsWith("LOCATED AT:")) {
        	...
        	holder.invListBarcode.setText(rowItem.getNusenate());
        	holder.invListBarcode.setTextColor( context.getResources().getColor(R.color.red) ); //red
            holder.invListDescr.setText(rowItem.getDecommodityf());
        	holder.invListDescr.setTextColor( context.getResources().getColor(R.color.red) ); //red
        }
        else if (rowItem.getType().equalsIgnoreCase("AT DESTINATION")) {
        	holder.invListBarcode.setText(rowItem.getNusenate());
        	holder.invListBarcode.setTextColor( context.getResources().getColor(R.color.green) ); //green
            holder.invListDescr.setText(rowItem.getDecommodityf());
        	holder.invListDescr.setTextColor( context.getResources().getColor(R.color.green) ); //green
        }
        else {
        	holder.invListBarcode.setText(rowItem.getNusenate());
