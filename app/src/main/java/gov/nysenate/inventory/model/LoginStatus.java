...
public class LoginStatus {
    ...
    @Expose
    private transient String nauser = null;
    @Expose
    private transient String destatus = null;
    @Expose
    private transient String cdseclevel = null;
    @Expose
    private transient int nustatus = INVALID;
    @Expose
    private transient int sqlErrorCode = -1;
    @Expose
    private transient Date dtpasswdexp = null;
    @Expose
    private transient boolean usernamePasswordValid = false;
